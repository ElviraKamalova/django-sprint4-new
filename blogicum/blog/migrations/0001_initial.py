# Generated by Django 5.2.16 on 2026-08-25 09:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Идентификатор страницы для URL;разрешены символы латиницы, цифры, дефиси подчёркивание.', unique=True, verbose_name='Идентификатор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Если установить дату и время в будущем — запись будет скрыта до наступления этого времени.', verbose_name='Дата и время публикации')),
